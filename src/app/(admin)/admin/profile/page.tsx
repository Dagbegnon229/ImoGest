...
const adminRoleColors: Record<string, string> = {
  super_admin: "bg-purple-100 text-purple-700",
  admin_manager: "bg-blue-100 text-blue-700",
  admin_support: "bg-amber-100 text-amber-700",
};

export default function AdminProfilePage() {
  const { user } = useAuth();
  const { admins, updateAdmin } = useData();
  ...
  function validatePassword(): boolean {
    ...
    } else if (admin && currentPassword !== admin.password) {
  ...
  async function handleChangePassword(e: React.FormEvent) {
    e.preventDefault();
    if (!validatePassword() || !admin) return;
        ...
        <div className="space-y-6">
          ...
          >
            <div className="space-y-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs text-[#6b7280]">Identifiant admin</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs text-[#6b7280]">Rôle</p>
                  <span
                    className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${adminRoleColors[admin.role] || ""}`}
                  >
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs text-[#6b7280]">Date de création</p>
          ...
          <Card>
            <div className="flex flex-col items-center py-4">
              ...
              <p className="text-xs text-[#6b7280] mt-1">{admin.phone}</p>
              <Badge
                variant={admin.role === "super_admin" ? "success" : "info"}
                className="mt-2"
              >
                {adminRoleLabels[admin.role] || admin.role}
              </Badge>
